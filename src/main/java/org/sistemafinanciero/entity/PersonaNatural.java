...
public class PersonaNatural implements java.io.Serializable {
    ...
    public PersonaNatural(BigInteger idPersonaNatural, TipoDocumento tipoDocumento, String numeroDocumento,
    ...
    public PersonaNatural(BigInteger idPersonaNatural, TipoDocumento tipoDocumento, String numeroDocumento,
            String apellidoPaterno, String apellidoMaterno, String nombres, Date fechaNacimiento, Sexo sexo,
            String estadoCivil, String ocupacion, String direccion, String referencia, String telefono,
            String celular, String email, String ubigeo, String codigoPais, Set titulars,
            Set personaJuridicas, Set accionistas, Set socios, Set trabajadors) {
        this.idPersonaNatural = idPersonaNatural;
        this.tipoDocumento = tipoDocumento;
        this.numeroDocumento = numeroDocumento;
        this.apellidoPaterno = apellidoPaterno;
