...
public class SucursalRESTService implements SucursalREST {
    ...
    public Response findAll(String filterText, Integer offset, Integer limit) {
        ...
        // return response;
        List<Sucursal> list = sucursalServiceNT.findAll(filterText, offset, limit);
    ...
    public Response countAll() {
        int count = sucursalServiceNT.count();
    ...
    public Response createAgencia(BigInteger id, Agencia agencia) {
        ...
        try {
            ...
            response = Response.status(Response.Status.CREATED).entity(Jsend.getSuccessJSend(idAgencia))
                    .build();
        } catch (NonexistentEntityException e) {
            Jsend jsend = Jsend.getErrorJSend(e.getMessage());
            response = Response.status(Response.Status.NOT_FOUND).entity(jsend).build();
